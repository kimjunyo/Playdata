...
public class DataClass {
	...
	public void init() { //초기화 메서드 //this.을 붙여야 찾는게 빨라지기때문에 속도가 빨라짐
		this.members.add(new MemberClass("92001", "590327-1839240", "이태규", 920, "교수", "1997")); 
		this.members.add(new MemberClass("92002", "690702-1350026", "고희석", 910, "부교수", "2003"));
		this.members.add(new MemberClass("92301", "741011-2765501", "최성희", 910, "부교수", "2005"));
		this.members.add(new MemberClass("92302", "750728-1102458", "김태석", 920, "교수", "1999"));
		this.members.add(new MemberClass("92501", "620505-1200546", "박철재", 900, "조교수", "2007"));
		this.members.add(new MemberClass("92502", "740101-1830264", "장민석", 910, "부교수", "2005"));
